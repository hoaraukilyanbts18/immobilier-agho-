/* =========================================================
   ...
   Une vraie version pourrait stocker ça dans la table "favorites"
   de Supabase, liée à l'utilisateur connecté (voir backend/schema.sql) —
   simplification assumée pour l'instant, pas une contrainte technique.
   ========================================================= */
